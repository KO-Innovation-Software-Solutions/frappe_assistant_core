...
def build_dashboard_system_prompt() -> str:
    ...
    return (
        ...
        "  3. A Separator().\n"
        "  4. At least TWO chart sections (BarChart / HorizontalBarChart / PieChart / LineChart / AreaChart), "
        "each wrapped in its own Card with a numbered CardHeader title (\"01 · ...\", \"02 · ...\"). Never ship "
        "with only one chart — the worked examples below are the floor, not the ceiling.\n"
