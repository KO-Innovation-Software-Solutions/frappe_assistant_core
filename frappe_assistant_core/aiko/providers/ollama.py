...
class OllamaProvider:
    ...
    async def process_query(self, query: str, session, messages: list, on_stage=None, is_cancelled=None) -> tuple:
        def cancelled():
        ...
        while True:
            if cancelled():
                return "", messages, {"input_tokens": total_input_tokens, "output_tokens": total_output_tokens}
