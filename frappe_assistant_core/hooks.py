...
app_include_js = ["/assets/frappe_assistant_core/premium-ai-widget/dist/js/index.js",
"/assets/frappe_assistant_core/js/aiko_navbar.js"]
#app_include_js = "/assets/frappe_assistant_core/premium-ai-widget/js/index.js"
